  ...
  return (
    <div className="projectvideo">
      ...
      <div className="technology">
        ...
        <Card name = "Text Editor" source1 = "https://www.linkedin.com/posts/vikrantprajapati_i-have-created-file-management-system-activity-7201896160947572736-dJiu?utm_source=share&utm_medium=member_android" source2="https://text-editor-vikrant.vercel.app/" discription = 'I have created this project using MERN technology in which we can do CRUD operation. https://github.com/PrajapatiVikrant/ Text-Editor ( frontend ) https://github.com/PrajapatiVikrant/ Texteditor- (backend)'/>
